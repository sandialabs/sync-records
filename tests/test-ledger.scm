  ...
  (let* ((debug '())
    ...
    (run-test
     (append
      ...
      (map install `((journal-1 (,standard-src '(control library standard) ,debug))
                     (journal-2 (,standard-src '(control library standard) ,debug))
                     (journal-3 (,standard-src '(control library standard) ,debug))
                     (journal-4 (,standard-src '(control library standard) ,debug))
                     (journal-5 (,standard-src '(control library standard) ,debug))
                     (journal-1 (,tree-src '(control class tree)))
                     (journal-2 (,tree-src '(control class tree)))
                     (journal-3 (,tree-src '(control class tree)))
                     (journal-4 (,tree-src '(control class tree)))
                     (journal-5 (,tree-src '(control class tree)))
                     (journal-1 (,chain-src '(control class chain)))
                     (journal-2 (,chain-src '(control class chain)))
                     (journal-3 (,chain-src '(control class chain)))
                     (journal-4 (,chain-src '(control class chain)))
                     (journal-5 (,chain-src '(control class chain)))
                     ...
                     (journal-4 (,config-src '(control class configuration)))
                     (journal-5 (,config-src '(control class configuration)))
                     ...
                     (journal-4 (,ledger-src '(control class ledger)))
                     (journal-5 (,ledger-src '(control class ledger)))))
