     ...
     (append
      ...
      (map query
           `(
             ...
             (journal-1 ((ledger 'get) '(-1 (*state* do pin that))) '(content "yes"))
             ...
             (journal-2 ((ledger 'get) '(-1 (*state* a b c*))) '(content 43))
             ...
             ;; (journal-1 ((ledger 'get) '(-1 (*peer* journal-2 chain) -1 (*state* a b))))
