           ...
           `((journal ((root 'set!) '(control test source)
             ...
             (journal (let ((object-1 ((std 'make) '(define-class (class-1)
                                                       ...
                                                       (define (set! self ~index value)
                                                         (set! (self '(1)) value))
                                                       (define (slice! self ~index) #t)
                                                       (define (prune! self ~index) #t))))
                        ...
                        ((root 'set!) '(control test deep) `(content ,((std 'dump) object-1)))) #t)
             (journal (let ((object ((std 'load) (cadr ((root 'get) '(control test deep))))))
             ...
             (journal (let ((object ((std 'load) (cadr ((root 'get) '(control test deep))))))
                        ...
                        ((std 'deep-call) object '("some path" 1) (lambda (obj) ((obj 'increment!))))
                        ((std 'deep-call) object '("some path" 1) (lambda (obj) ((obj 'get) #f)))
